...
local mainWidth = isMobile and math.min(viewportSize.X * 0.96, 538) or 538
local mainHeight = isMobile and math.min(viewportSize.Y * 0.75, 288) or 288
